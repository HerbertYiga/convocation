  ...
  <div class="row">
         	...
         	<div class="col-md-8">
              ...
              <div class="panel panel-default" >
                  ...
                  <div class="panel-body">
                    ...
                    <form id=""  action="${loginUrl}"   method="POST"  class="form-horizontal" >
        <fieldset>
    ...
    <div class="form-group">
        ...
        if (errorString != null && errorString.trim().equals("true")) {
        	...
        	out.println("<span class=\"errorblock\"> <span></span>Incorrect login name or password.please insert the correct ones");
        }
    %>
          </h5>
        <br>  
