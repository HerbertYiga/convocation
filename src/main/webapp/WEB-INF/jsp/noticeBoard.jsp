...
<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
 ...
 <div class="row">
        <div class="col-md-9">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title" style="color:green">Send Notice</h3>
                ...
                <div class="panel-body">
                     <form:form id=""  action="saveNoticesByAdmin"   method="POST"  class="form-horizontal"  commandName="messagesbean">
        <fieldset>
        <div class="form-group">
            <label class="col-lg-2 control-label" for="firstName">Notice Heading</label>
            <div class="col-lg-10">
            <form:input path="noticeHeading" class="form-control" placeholder="heading" id="one" type="username" value=""/>
         <form:errors path="noticeHeading" cssStyle="color: #ff0000;" />
            </div>
      ...
      <div class="form-group">
            <label class="col-lg-2 control-label" for="otherName">Notice</label>
            <div class="col-lg-10">
            <form:textarea path="noticeBody" class="form-control" placeholder="notice" type="username" cols="50" rows="10" />
            <form:errors path="noticeBody" cssStyle="color: #ff0000;" />
             </div>
