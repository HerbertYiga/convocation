         	...
         	<div class="col-md-12">
              ...
              <div class="panel panel-default" >
                  ...
                  <div class="panel-body">
                    ...
                    <!-- -Form    -->
         <form:form id=""  action="/Convocation/updateuser"   method="POST"  class="form-horizontal" commandName="edituser">
        <fieldset>
        <div class="form-group">
            <label class="col-lg-2 control-label" for="firstName">User Name</label>
            <div class="col-lg-10">
            <form:input path="username" class="form-control" placeholder="Full Name" id="one" type="text" value="${user.username}"/>
...
<form:select path="authority" class="form-control">
   ...
   <br>  
      ...
      <div class="form-group">
            <label class="col-lg-2 control-label" for="otherName">Phone Number</label>
            <div class="col-lg-10">
            <form:input path="phoneNumber" class="form-control" placeholder="Phone Number" type="text" value="${user.phoneNumber}"/>
        ...
        <div class="form-group">
            <label class="col-lg-2 control-label" for="otherName"></label>
            <div class="col-lg-10">
            <form:input path="userId" class="form-control" placeholder="Course Studied" type="hidden"  value="${user.userId}" />
