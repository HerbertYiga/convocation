...
<div class="container">
  ...
  <div class="row">
	<div class="col-sm-3">
     ...
     <li><a href="<c:url value="/admin"/>" target=""><i class="glyphicon glyphicon-plus"></i> Add Details</a></li>
            ...
            <!-- center left-->	
         	<div class="col-md-12">
              ...
              <div class="panel panel-default" >
                  <div class="panel-heading">  <h4><b>Send Email</b></h4></div>
                  <div class="panel-body">
                    
                    
               <form:form id=""  action="adminsendEmail"   method="POST"  class="form-horizontal" >
        <fieldset>
