...
<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
    ...
    <ul class="nav nav-pills nav-stacked" style="border-right:1px solid black">
        ...
        <li><a href="<c:url value="/admin" />"><i class="glyphicon glyphicon-home""></i> Home</a></li>
         ...
         <li><a href="<c:url value="/headingsView" />"> <i class="glyphicon glyphicon-book""></i> Sent Notices</a></li>
        ...
        <div class="col-md-9">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title" style="color:green">View Notices</h3>
               ...
               <c:forEach var="notices" items="${list}"> 
                          <tr>
                            ...
                            <td style="color:green"><b>${notices.noticeHeading}</b></td>
