...
<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
 ...
 <div class="row">
        <div class="col-md-9">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title" style="color:green">Send Message</h3>
                ...
                <div class="panel-body">
                     <form:form id=""  action="saveMessagesByAdmin"   method="POST"  class="form-horizontal"  commandName="messagesbean">
        <fieldset>
        <div class="form-group">
            <label class="col-lg-2 control-label" for="firstName">Message Heading</label>
            <div class="col-lg-10">
            <form:input path="theHeading" class="form-control" placeholder="" id="one" type="username" value=""/>
         <form:errors path="theHeading" cssStyle="color: #ff0000;" />
            </div>
      ...
      <div class="form-group">
            ...
            <div class="col-lg-10">
            <form:textarea path="messageBody" class="form-control" placeholder="Message" type="username" cols="50" rows="10" />
            <form:errors path="messageBody" cssStyle="color: #ff0000;" />
             </div>
