...
<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
 ...
 <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title" style="color:green" >Click view to see the message</h3>
  ...
  <table class="table table-striped table-bordered table-list">
                  ...
                  <tbody id="myTable">
               <c:forEach var="headings" items="${list}"> 
                          <tr>
                         
                            <td >${headings.theHeading}</td>
                            
                            <td style="color:green;">  <a  href="headingsidbystudent/${headings.headingId}">view</a>
                           </td>
                          </tr>
                             </c:forEach>
