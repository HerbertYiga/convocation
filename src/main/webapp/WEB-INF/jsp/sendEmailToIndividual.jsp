...
<div class="container">
	<div class="row">
        ...
        <div class="searchform text-center">
                <br/>
                <form:form method="POST"  action="EmailRegno" commandName="studentsformbyregnoformail" >
                  ...
                  <div class="panel-body">
                    ...
                    <!-- -List of all former students-->
                       <form:form id="yourForm" action="deleteslectedstudents" method="POST" commandName="" >    
                  ...
                  <tbody id="myTable">
                          ...
                          <tr>
                            ...
                            <td class="hidden-xs">${studentsformbyregnoformail.id}</td>
                            <td>${studentsformbyregnoformail.fullName}</td>
                            <td>${studentsformbyregnoformail.email}</td>
                            <td>${studentsformbyregnoformail.phoneNumber}</td>
                            <td>${studentsformbyregnoformail.courseStudied}</td>
                                 <td>${studentsformbyregnoformail.regNo}</td>
                                      <td>
         
                </td>
                      
                         
                                       <td width="90px">   <img width="100" src="<c:url value='/resources/image/${studentsformbyregnoformail.imageLink}'/>" alt="Photo of Youthful William" id="pic" />
         </td>
                             <td align="center">
         
                              <a class="btn btn-primary" href="<c:url value="/sendEmailForm"/>"><em class="fa fa-trash"></em>Send Email</a>
                            </td>
                          </tr>
