    ...
    <div class="col-sm-9">
      ...
      <!-- column 2 -->	
	   ...
	   <div class="row">
         	...
         	<div class="col-md-12">
              ...
              <div class="panel panel-default" >
                  ...
                  <thead>
                    <tr>
                        ...
                        <th>Phone Number </th>
                         ...
                         <th style="color:#1E90FF">Edit </th>
                         <th style="color:#1E90FF">Delete </th>
               ...
               <c:forEach var="userdetails" items="${list}"> 
                          ...
                          <td>
                       <a  href="<c:url value="/edituserdetails/${userdetails.userId}"/>" class="btn btn-primary">Edit </a>   
          ...
          <a  href="<c:url value="/deleteuserdetails/${userdetails.userId}"/>" class="btn btn-danger">Delete </a>
