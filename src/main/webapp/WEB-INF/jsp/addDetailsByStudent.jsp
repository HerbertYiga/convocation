            ...
            <!-- center left-->	
         	<div class="col-md-12">
              ...
              <div class="panel panel-default" >
                  <div class="panel-heading">  <h4><b>Enter Your Details</b></h4></div>
                  <div class="panel-body">
                    
                    <!-- -Form    -->
         <form:form id=""  action="saveStudentDetailsbyStudents"   method="POST" enctype="multipart/form-data" class="form-horizontal" commandName="addstudentdetailsbyuser">
        <fieldset>
